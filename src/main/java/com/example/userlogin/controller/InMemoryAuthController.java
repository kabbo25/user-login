...
import com.example.userlogin.service.InMemoryUserService;
...
public class InMemoryAuthController {
    ...
    public InMemoryAuthController(InMemoryUserService userService) {
    ...
    public ResponseEntity<String> getUserProfile() {
        ...
        return ResponseEntity.ok("User profile for: " + auth.getName() + " - Approach: InMemory UserDetailsService");
    }

    @GetMapping("/admin/dashboard")
    public ResponseEntity<String> getAdminDashboard() {
        Authentication auth = SecurityContextHolder.getContext().getAuthentication();
        return ResponseEntity.ok("Admin dashboard for: " + auth.getName() + " - Approach: InMemory UserDetailsService");
    }
}