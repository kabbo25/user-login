...
import com.example.userlogin.service.JpaUserService;
...
public class JpaAuthController {
    ...
    public ResponseEntity<String> getUserProfile() {
        ...
        return ResponseEntity.ok("User profile for: " + auth.getName() + " - Approach: Custom JPA UserDetailsService");
    }

    @GetMapping("/admin/dashboard")
    public ResponseEntity<String> getAdminDashboard() {
        Authentication auth = SecurityContextHolder.getContext().getAuthentication();
        return ResponseEntity.ok("Admin dashboard for: " + auth.getName() + " - Approach: Custom JPA UserDetailsService");
    }
}